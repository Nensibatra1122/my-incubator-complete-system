...
> ⚠️ **Security Note:** All sensitive credentials, tokens, and database passwords have been abstracted and replaced with placeholders. Refer to [§14 Production Hardening Checklist](#-14-production-hardening-checklist) for proper configuration using server-side `.env` files and GitHub Actions Secrets.
...
graph TB
    ...
    D[("Shared MySQL / RDS Databaseincubator_db")]
...
Execute the following commands line by line in your terminal to prepare the Ubuntu server environment:
...
Create the application database and user inside MySQL:
```sql
sudo mysql -u root -p
```
```sql
...
```bash
git clone https://github.com/your-username/incubator-system.git
cd incubator-system
```
...
|:---:|:---:|
| ![Login](Frontend/Screenshots/Login.PNG) | ![Signup](Frontend/Screenshots/Signup.PNG) |

### 📊 Dashboard & System Logs
| System Dashboard | System Logs Monitor |
|:---:|:---:|
| ![Dashboard](Frontend/Screenshots/Dashboard.PNG) | ![System Logs](Frontend/Screenshots/Systemlogs.PNG) |

### 💡 Idea Pipeline & Feedback Modules
| Idea Pipeline Workflow | Feedback Portal |
|:---:|:---:|
| ![Idea Pipeline](Frontend/Screenshots/Idea_Pipeline.PNG) | ![Feedback](Frontend/Screenshots/Feedback.PNG) |

### 🤝 Mentors & Investors Directory
| Mentors Directory | Investors Directory |
|:---:|:---:|
| ![Mentors](Frontend/Screenshots/Mentors.PNG) | ![Investors](Frontend/Screenshots/Investors.PNG) |

### 👥 Community, Finance & Notifications
| Community Feed | Finance Portal | Notifications Center |
|:---:|:---:|:---:|
| ![Community](Frontend/Screenshots/Community_page.PNG) | ![Finance](Frontend/Screenshots/Finance.PNG) | ![Notifications](Frontend/Screenshots/Notification.PNG) |

### 🛠️ Management & Interactive Activities
| Manage Tags | Activity & Comments | Additional Capture |
|:---:|:---:|:---:|
| ![Manage Tags](Frontend/Screenshots/Manage_tags.PNG) | ![Activity Comments](Frontend/Screenshots/Activity_Like_Comment.PNG) | ![Capture](Frontend/Screenshots/Capture.PNG) |
